...
def train(gpu, args):
    ...
    # fetch dataloader
    db = dataset_factory(['scannet'], datapath=args.datapath, n_frames=args.n_frames, fmin=args.fmin, fmax=args.fmax)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='scannet', help='name your experiment')
    parser.add_argument('--ckpt', default="droid.pth", help='checkpoint to restore')
    parser.add_argument('--datasets', nargs='+', help='lists of datasets for training')
    parser.add_argument('--datapath', default='datasets/scannet', help="path to dataset directory")
