...
if __name__ == '__main__':
    ...
    parser.add_argument("--buffer", type=int, default=4000) #对于kitti 大一些 1300 1800 2000
    ...
    for seqid in test_seqs:
        ...
        #     continue   
        seqpath = os.path.join(args.datapath,'sequences',seqid)
        ...
        posepath = os.path.join(args.datapath,'poses')
        gt_file = os.path.join(posepath, seqid+".txt")
