...
# from tartanair
def image_stream(datapath, image_size=[480, 640], intrinsics_vec=[525.4229, 526.9468000000001, 326.4371, 239.5824], stereo=False):
    """ image generator """
    # 内参格式 fx fy cx cy
    intrinsics_vec=[525.4229, 526.9468000000001, 326.4371, 239.5824] # for B
